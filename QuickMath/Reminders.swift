...
enum Reminders {
    private static let identifier = "sprintly.daily.reminder"
    ...
    static func schedule(hour: Int, minute: Int) {
        ...
        content.title = "How's your sprint going?"
        content.body = "Did you make progress on your goal today? Tap to log it."
